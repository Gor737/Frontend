      ...
      <div className="mx-auto max-w-2xl">
        <div className="mb-10 border-b border-[#d4af37]/30 pb-6">
          ...
          <p className="mt-3 max-w-md text-sm leading-6 text-[#9f956d]">
            Create a profile and add them to your community directory.
          </p>
        </div>
        ...
        >
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            ...
            <label className="flex flex-col gap-2">
              ...
              <select
                ...
                id="gender"
                defaultValue=""
                className="h-14 rounded-2xl border border-[#d4af37]/25 bg-[#0b0b0b] px-4 text-sm text-[#f8f3d9] outline-none transition focus:border-[#f0d87a] focus:ring-1 focus:ring-[#d4af37]/50"
              >
          ...
          <div className="mt-9 flex justify-end border-t border-[#d4af37]/15 pt-6">
            <button
              type="submit"
